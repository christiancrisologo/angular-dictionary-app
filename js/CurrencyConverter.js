...
var app = angular.module('CurrencyConverterApi', [])

	.directive('cyCurrencyConverter', ['CcyConverterService','Helper','$compile', function(Feed,Helper,$compile){
		// Runs during compile
		return {
			// name: '',
			// priority: 1,
	...
	.factory('CcyConverterService',['$http', function($http){
        return {
            get:
